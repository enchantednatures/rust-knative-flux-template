...
<!--
  ...
  NOTE: All requirements must align with constitution principles:
  - Observability: Include telemetry/logging requirements
  - Performance: Specify latency/throughput targets
  - Configuration: Define environment-specific configs if needed
  - Error Handling: Specify error scenarios and recovery expectations
-->
