...
Guide for contributing to test-app.
...
# Add upstream remote
git remote add upstream https://github.com/ORIGINAL_ORG/test-app.git
```
...
# https://github.com/YOUR_USERNAME/test-app/compare/feature/my-feature
```
