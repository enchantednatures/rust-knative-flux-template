...
pub fn init_metrics() -> anyhow::Result<()> {
    // Initialize the metrics-exporter-prometheus with default configuration
    // Metrics will be available at GET /metrics endpoint (added by tower-http integration)
