...
This document explains the system architecture, design decisions, and component interactions in audio-exporter.
...
| MinIO/S3 | Object storage | REQUIRED | make dev-up | AWS S3 | |
