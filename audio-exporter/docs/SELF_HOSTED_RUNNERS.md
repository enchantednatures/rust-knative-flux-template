...
This document describes the self-hosted GitHub Actions runners setup for audio-exporter.
...
```bash
git clone https://github.com/your-org/audio-exporter.git
cd audio-exporter
```
...
# Navigate to: https://github.com/your-org/audio-exporter/settings/actions/runners
```
...
# Specific runner
sudo systemctl status actions.runner.your-org-audio-exporter.runner-1.service
```
...
# Specific runner
sudo journalctl -u actions.runner.your-org-audio-exporter.runner-1.service -f
...
# Specific runner
sudo systemctl restart actions.runner.your-org-audio-exporter.runner-1.service
```
...
Check runner status:
- https://github.com/your-org/audio-exporter/settings/actions/runners
...
# Check logs
sudo journalctl -u actions.runner.your-org-audio-exporter.runner-1.service -n 100
