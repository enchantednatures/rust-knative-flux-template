...
Guide for contributing to audio-exporter.
...
# Clone your fork
git clone https://github.com/YOUR_USERNAME/audio-exporter.git
cd audio-exporter

# Add upstream remote
git remote add upstream https://github.com/ORIGINAL_ORG/audio-exporter.git
```
...
# https://github.com/YOUR_USERNAME/audio-exporter/compare/feature/my-feature
```
