...
aws s3api copy-object \
  --bucket example-app-data \
  --copy-source example-app-data/documents/file.txt?versionId=VERSION_ID \
...
aws s3api put-bucket-replication \
  --bucket example-app-data-primary \
    ...
    "Rules": [
      {
        ...
        "Prefix": "",
        "Destination": {
          "Bucket": "arn:aws:s3:::example-app-data-backup",
...
aws s3 sync s3://example-app-data/ s3://example-app-data-backup/
