...
All notable changes to example-app will be documented in this file.
...
- [Latest Release](https://github.com/your-org/example-app/releases/latest)
- [GitHub Releases](https://github.com/your-org/example-app/releases)
